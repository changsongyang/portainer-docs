...
The commands in our [installation guide](../../start/install/server/) include the creation of a portainer\_data volume for Portainer to store data, and using this will ensure that the configuration remains even when the Portainer container is restarted, upgraded or removed.
...
<figure><img src="../../.gitbook/assets/2.9-swarm-portainer-volume-constrain-1.gif" alt=""><figcaption></figcaption></figure>

Next, from the menu select **Services** then the portainer\_portainer service, then click **Placement constraints**.

<figure><img src="../../.gitbook/assets/2.9-swarm-portainer-volume-constraints-2.gif" alt=""><figcaption></figcaption></figure>
